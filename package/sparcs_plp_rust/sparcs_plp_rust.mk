...
define SPARCS_PLP_RUST_INSTALL_TARGET_CMDS
    ...
    $(INSTALL) -D -m 0755 $(@D)/target/$(RUSTC_TARGET_NAME)/release/payload-control $(TARGET_DIR)/usr/bin/sparcs/sparcs-payload-control; \
    $(INSTALL) -D -m 0755 $(@D)/target/$(RUSTC_TARGET_NAME)/release/sci-obs $(TARGET_DIR)/usr/bin/sparcs/sparcs-sci-obs; \
