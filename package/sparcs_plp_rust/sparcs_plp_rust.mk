...
define SPARCS_PLP_RUST_INSTALL_TARGET_CMDS
    ...
    $(INSTALL) -D -m 0755 $(@D)/data/master_bias.raw.bz2 $(TARGET_DIR)/etc/sparcs/reference_frames/biases/master_bias.raw.bz2;\
    $(INSTALL) -D -m 0755 $(@D)/data/master_dark.raw.bz2 $(TARGET_DIR)/etc/sparcs/reference_frames/darks/master_dark.raw.bz2;
endef
